...
The system captures live video from a webcam and processes each frame to detect hands. Once detected, the hand landmarks are extracted and analyzed to determine finger positions and gestures.The output is displayed on the screen with visual indicators such as bounding boxes, gesture labels, and finger counts.
